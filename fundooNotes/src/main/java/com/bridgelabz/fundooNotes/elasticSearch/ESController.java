...
//	 @PostMapping(value="/createnote/search")
//	 public List<Note> getNoteByAllFeilds(@RequestParam("searchName") String searchName,@RequestParam("userid") int userid) throws Exception 
//	 {
//		 System.out.println("!!!!!!!");
